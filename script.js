document.addEventListener('DOMContentLoaded', () => {
  ...
  // Contagem regressiva para 26/12/2026 às 15:00:00
  ...
  function showMusicButton(isPlaying, unavailable = false) {
    ...
    floatingMusicButton.innerHTML = '<span aria-hidden="true">' + icon + '</span><span class="sr-only">' + label + '</span>';
    floatingMusicButton.setAttribute('aria-label', label);
    floatingMusicButton.title = label;
  }
